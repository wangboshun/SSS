...
@boost('consumer_2', qps=1000, concurrent_mode=5, broker_kind=BrokerEnum.RABBITMQ_AMQPSTORM, create_logger_file=False)
...
@boost('consumer_3', qps=1000, concurrent_mode=5, broker_kind=BrokerEnum.RABBITMQ_AMQPSTORM, create_logger_file=False)
