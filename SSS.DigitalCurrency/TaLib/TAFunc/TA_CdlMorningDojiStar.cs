...
namespace TALibrary
{
    public partial class Core
    {
        ...
        Label_035B:
            ...
            if ((Math.Abs(inClose[i - 2] - inOpen[i - 2]) > ((Globals.candleSettings[0].factor * num53) / num47)) && (((inClose[i - 2] < inOpen[i - 2]) ? -1 : 1) == -1))
            {
                double num40;
                double num46;
                if (Globals.candleSettings[3].avgPeriod != 0.0)
                {
                    num46 = BodyDojiPeriodTotal / Globals.candleSettings[3].avgPeriod;
                }
                else
                {
                    double num45;
                ...
                if (Math.Abs(inClose[i - 1] - inOpen[i - 1]) <= ((Globals.candleSettings[3].factor * num46) / num40))
                {
                    double num38;
                    double num39;
                    ...
                    if (num39 < num38)
                    {
                        ...
                        {
                            num37 = BodyShortPeriodTotal / Globals.candleSettings[2].avgPeriod;
                        }
                        else
                        {
                            double num36;
                        ...
                        if (((Math.Abs(inClose[i] - inOpen[i]) > ((Globals.candleSettings[2].factor * num37) / num31)) && (((inClose[i] < inOpen[i]) ? -1 : 1) == 1)) && (inClose[i] > (inClose[i - 2] + (Math.Abs(inClose[i - 2] - inOpen[i - 2]) * optInPenetration))))
                        {
