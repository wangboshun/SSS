    ...
    public partial class Core
    {
        ...
        Label_0413:
            ...
            if (((inClose[i - 1] < inOpen[i - 1]) ? -1 : 1) == -num70)
            {
                ...
                if (Math.Abs(inClose[i - 1] - inOpen[i - 1]) > ((Globals.candleSettings[0].factor * num69) / num63))
                {
                    double num55;
                    double num61;
                    double num62;
                    ...
                    if ((inHigh[i - 1] - num62) < ((Globals.candleSettings[7].factor * num61) / num55))
                    {
                        ...
                        if ((num54 - inLow[i - 1]) < ((Globals.candleSettings[7].factor * num53) / num47))
                        {
                            ...
                            if (Math.Abs(inClose[i] - inOpen[i]) > ((Globals.candleSettings[0].factor * num46) / num40))
                            {
                                double num32;
                                double num38;
                                double num39;
                                ...
                                if (Globals.candleSettings[7].avgPeriod != 0.0)
                                {
                                    num38 = ShadowVeryShortPeriodTotal[0] / Globals.candleSettings[7].avgPeriod;
                                }
                                else
                                {
                                    double num37;
                                ...
                                if ((inHigh[i] - num39) < ((Globals.candleSettings[7].factor * num38) / num32))
                                {
                                    ...
                                    if (Globals.candleSettings[7].avgPeriod != 0.0)
                                    {
                                        num30 = ShadowVeryShortPeriodTotal[0] / Globals.candleSettings[7].avgPeriod;
                                    }
                                    else
                                    {
                                        double num29;
