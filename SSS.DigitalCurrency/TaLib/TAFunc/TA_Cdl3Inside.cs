...
namespace TALibrary
{
    public partial class Core
    {
        ...
        Label_0238:
            ...
            if (Math.Abs(inClose[i - 2] - inOpen[i - 2]) > ((Globals.candleSettings[0].factor * num39) / num33))
            {
                double num26;
                double num32;
                ...
                if (Math.Abs(inClose[i - 1] - inOpen[i - 1]) <= ((Globals.candleSettings[2].factor * num32) / num26))
                {
                    double num24;
                    double num25;
                    if (inClose[i - 1] > inOpen[i - 1])
