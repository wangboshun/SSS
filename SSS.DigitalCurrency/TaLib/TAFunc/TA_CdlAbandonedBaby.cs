...
namespace TALibrary
{
    public partial class Core
    {
        ...
        Label_035B:
            ...
            if (Math.Abs(inClose[i - 2] - inOpen[i - 2]) > ((Globals.candleSettings[0].factor * num52) / num46))
            {
                double num39;
                double num45;
                ...
                if (Math.Abs(inClose[i - 1] - inOpen[i - 1]) <= ((Globals.candleSettings[3].factor * num45) / num39))
                {
                    double num32;
                    double num38;
