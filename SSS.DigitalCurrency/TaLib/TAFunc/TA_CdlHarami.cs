...
namespace TALibrary
{
    public partial class Core
    {
        ...
        Label_0234:
            ...
            if (Math.Abs(inClose[i - 1] - inOpen[i - 1]) > ((Globals.candleSettings[0].factor * num39) / num33))
            {
                double num26;
                double num32;
                ...
                if (Math.Abs(inClose[i] - inOpen[i]) <= ((Globals.candleSettings[2].factor * num32) / num26))
                {
                    double num24;
                    double num25;
                    if (inClose[i] > inOpen[i])
