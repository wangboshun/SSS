    ...
    public partial class Core
    {
        ...
        Label_024F:
            if ((((inClose[i - 1] < inOpen[i - 1]) ? -1 : 1) == -1) && (((inClose[i] < inOpen[i]) ? -1 : 1) == -1))
            {
                ...
                if (Math.Abs(inClose[i - 1] - inOpen[i - 1]) > ((Globals.candleSettings[0].factor * num34) / num28))
                {
                    double num21;
                    double num27;
                    ...
                    if (((Math.Abs(inClose[i] - inOpen[i]) <= ((Globals.candleSettings[2].factor * num27) / num21)) && (inOpen[i] < inOpen[i - 1])) && (inClose[i] > inClose[i - 1]))
                    {
