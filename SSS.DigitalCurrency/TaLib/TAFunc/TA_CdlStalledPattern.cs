    ...
    public partial class Core
    {
        ...
        Label_0656:
            if ((((inClose[i - 2] >= inOpen[i - 2]) && (inClose[i - 1] >= inOpen[i - 1])) && (inClose[i] >= inOpen[i])) && ((inClose[i] > inClose[i - 1]) && (inClose[i - 1] > inClose[i - 2])))
            {
                ...
                if (Math.Abs(inClose[i - 2] - inOpen[i - 2]) > ((Globals.candleSettings[0].factor * num83) / num77))
                {
                    double num70;
                    double num76;
                    if (Globals.candleSettings[0].avgPeriod != 0.0)
                    ...
                    if (Math.Abs(inClose[i - 1] - inOpen[i - 1]) > ((Globals.candleSettings[0].factor * num76) / num70))
                    {
                        double num62;
                        double num68;
                        double num69;
                        ...
                        if (((inHigh[i - 1] - num69) < ((Globals.candleSettings[7].factor * num68) / num62)) && (inOpen[i - 1] > inOpen[i - 2]))
                        {
                            ...
                            if (inOpen[i - 1] <= (inClose[i - 2] + ((Globals.candleSettings[8].factor * num61) / num55)))
                            {
                                ...
                                if (Math.Abs(inClose[i] - inOpen[i]) < ((Globals.candleSettings[2].factor * num54) / num48))
                                {
                                    double num41;
                                    double num47;
                                    if (Globals.candleSettings[8].avgPeriod != 0.0)
                                    ...
                                    if (inOpen[i] >= ((inClose[i - 1] - Math.Abs(inClose[i] - inOpen[i])) - ((Globals.candleSettings[8].factor * num47) / num41)))
                                    {
