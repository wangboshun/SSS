    ...
    public partial class Core
    {
        ...
        Label_0345:
            ...
            if (((inClose[i - 1] < inOpen[i - 1]) ? -1 : 1) == -num50)
            {
                ...
                if (Math.Abs(inClose[i - 1] - inOpen[i - 1]) > ((Globals.candleSettings[0].factor * num49) / num43))
                {
                    double num36;
                    double num42;
                    if (Globals.candleSettings[0].avgPeriod != 0.0)
                    ...
                    if (Math.Abs(inClose[i] - inOpen[i]) > ((Globals.candleSettings[0].factor * num42) / num36))
                    {
                        double num29;
                        double num35;
