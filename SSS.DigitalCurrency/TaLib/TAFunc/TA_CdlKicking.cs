    ...
    public partial class Core
    {
        ...
        Label_0413:
            ...
            if (((inClose[i - 1] < inOpen[i - 1]) ? -1 : 1) == -num68)
            {
                ...
                if (Math.Abs(inClose[i - 1] - inOpen[i - 1]) > ((Globals.candleSettings[0].factor * num67) / num61))
                {
                    double num53;
                    double num59;
                    double num60;
                    ...
                    if ((inHigh[i - 1] - num60) < ((Globals.candleSettings[7].factor * num59) / num53))
                    {
                        ...
                        if ((num52 - inLow[i - 1]) < ((Globals.candleSettings[7].factor * num51) / num45))
                        {
                            ...
                            if (Math.Abs(inClose[i] - inOpen[i]) > ((Globals.candleSettings[0].factor * num44) / num38))
                            {
                                ...
                                if (Globals.candleSettings[7].avgPeriod != 0.0)
                                {
                                    num36 = ShadowVeryShortPeriodTotal[0] / Globals.candleSettings[7].avgPeriod;
                                }
                                else
                                {
                                    double num35;
                                ...
                                if ((inHigh[i] - num37) < ((Globals.candleSettings[7].factor * num36) / num30))
                                {
                                    ...
                                    if (Globals.candleSettings[7].avgPeriod != 0.0)
                                    {
                                        num28 = ShadowVeryShortPeriodTotal[0] / Globals.candleSettings[7].avgPeriod;
                                    }
                                    else
                                    {
                                        double num27;
