    ...
    public partial class Core
    {
        ...
        Label_0272:
            if (((inClose[i - 1] < inOpen[i - 1]) ? -1 : 1) == -1)
            {
                ...
                if (((Math.Abs(inClose[i - 1] - inOpen[i - 1]) > ((Globals.candleSettings[0].factor * num34) / num28)) && (inClose[i] >= inOpen[i])) && (inOpen[i] < inLow[i - 1]))
                {
                    double num21;
                    double num27;
                    ...
                    if ((inClose[i] > (inClose[i - 1] + ((Globals.candleSettings[10].factor * num27) / num21))) && (inClose[i] <= (inClose[i - 1] + (Math.Abs(inClose[i - 1] - inOpen[i - 1]) * 0.5))))
                    {
