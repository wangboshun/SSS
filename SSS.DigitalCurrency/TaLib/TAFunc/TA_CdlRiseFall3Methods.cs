...
namespace TALibrary
{
    public partial class Core
    {
        ...
        Label_04FF:
            ...
            if (Math.Abs(inClose[i - 4] - inOpen[i - 4]) > ((Globals.candleSettings[0].factor * num84) / num78))
            {
                double num71;
                double num77;
                ...
                if (Math.Abs(inClose[i - 3] - inOpen[i - 3]) < ((Globals.candleSettings[2].factor * num77) / num71))
                {
                    double num64;
                    double num70;
                    if (Globals.candleSettings[2].avgPeriod != 0.0)
                    ...
                    if (Math.Abs(inClose[i - 2] - inOpen[i - 2]) < ((Globals.candleSettings[2].factor * num70) / num64))
                    {
                        double num57;
                        double num63;
                        if (Globals.candleSettings[2].avgPeriod != 0.0)
                        ...
                        if (Math.Abs(inClose[i - 1] - inOpen[i - 1]) < ((Globals.candleSettings[2].factor * num63) / num57))
                        {
                            double num50;
                            double num56;
                            if (Globals.candleSettings[0].avgPeriod != 0.0)
                            ...
                            if (Math.Abs(inClose[i] - inOpen[i]) > ((Globals.candleSettings[0].factor * num56) / num50))
                            {
                                int num49;
                                if (inClose[i - 3] >= inOpen[i - 3])
                                {
