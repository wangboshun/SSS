    ...
    public partial class Core
    {
        ...
        Label_0336:
            if ((((((inClose[i - 3] < inOpen[i - 3]) ? -1 : 1) == -1) && (((inClose[i - 2] < inOpen[i - 2]) ? -1 : 1) == -1)) && (((inClose[i - 1] < inOpen[i - 1]) ? -1 : 1) == -1)) && (((inClose[i] < inOpen[i]) ? -1 : 1) == -1))
            {
                ...
                {
                    num51 = ShadowVeryShortPeriodTotal[3] / Globals.candleSettings[7].avgPeriod;
                }
                else
                {
                    double num50;
                ...
                if ((num52 - inLow[i - 3]) < ((Globals.candleSettings[7].factor * num51) / num45))
                {
                    ...
                    if (Globals.candleSettings[7].avgPeriod != 0.0)
                    {
                        num43 = ShadowVeryShortPeriodTotal[3] / Globals.candleSettings[7].avgPeriod;
                    }
                    else
                    {
                        double num42;
                    ...
                    if ((inHigh[i - 3] - num44) < ((Globals.candleSettings[7].factor * num43) / num37))
                    {
                        ...
                        if (Globals.candleSettings[7].avgPeriod != 0.0)
                        {
                            num35 = ShadowVeryShortPeriodTotal[2] / Globals.candleSettings[7].avgPeriod;
                        }
                        else
                        {
                            double num34;
                        ...
                        if ((num36 - inLow[i - 2]) < ((Globals.candleSettings[7].factor * num35) / num29))
                        {
                            ...
                            if (Globals.candleSettings[7].avgPeriod != 0.0)
                            {
                                num27 = ShadowVeryShortPeriodTotal[2] / Globals.candleSettings[7].avgPeriod;
                            }
                            else
                            {
                                double num26;
                            ...
                            if ((inHigh[i - 2] - num28) < ((Globals.candleSettings[7].factor * num27) / num21))
                            {
                                ...
                                if (num20 < num19)
                                {
                                    ...
                                    if (Globals.candleSettings[7].avgPeriod != 0.0)
                                    {
                                        num17 = ShadowVeryShortPeriodTotal[1] / Globals.candleSettings[7].avgPeriod;
                                    }
                                    else
                                    {
                                        double num16;
